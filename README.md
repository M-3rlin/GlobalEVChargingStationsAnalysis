...
**Core Question:** How can we optimise the EV charging network to optiising pricing choices, station availability, and vehicle efficiency for diverse user groups?

This project analyses real-world charging  session and 2025 ev car market data to answer this question. We have built a centralised dashboard that allows users to:
